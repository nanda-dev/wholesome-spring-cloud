...
**NOTE:** Bus Refresh seems to be having issues when used along with Spring Cloud Stream function definitions. Till a solution is found, Bus is disabled in the app.
